...
export default function ProfileScreen({ navigation }) {
    ...
    const sortedDateKeys = useMemo(() => {
        return Object.keys(groupedHistory).sort((a, b) => {
            // Un pequeño hack para ordenar por fecha real si es posible, 
            // pero como la key es string formateado, vamos a asumir que
            // el orden de inserción o el sorting de las fechas originales
            // sería mejor. Para este demo, el sort simple basta.
            return 0;
        });
    }, [groupedHistory]);
                ...
                <View style={styles.profileSection}>
                    <View style={styles.profileHeader}>
                        ...
                        <View style={styles.driverInfo}>
                            <Text style={styles.driverName}>Fernando González</Text>
                            <Text style={styles.driverId}>ID: #GS-50203</Text>
